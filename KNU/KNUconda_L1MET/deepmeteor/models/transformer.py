...
class Transformer(ModelBase):
	...
	def __init__(self, config: TransformerConfig):
		...
		# >> Comment-out ScatterMean for L1MET method
		#self.aggregator = ScatterMean()
		# Edited by Jiwoong <<

		# >> BatchNorm1d : (N,L,E)  change to nn.Linear for corr-method
	...
	def forward(self,
		...
		# >> Edited for L1MET method
		#output = self.regression_head(z)
		corr_factor = self.regression_head(z).squeeze()
		print("CHEKING DIMENSION....#######")
		print(corr_factor.shape,puppi_cands_cont[...,:2].shape)
		corrected_puppi  = corr_factor * puppi_cands_cont[...,:2]
		output = corrected_puppi.sum(dim=1) 
		# << Edited by Jiwoong

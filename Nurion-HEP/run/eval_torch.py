...
plt.legend()
#plt.show()
plt.savefig(args.input+'/Score_1.png')
plt.close()
...
plt.legend()
#plt.show()
plt.savefig(args.input+'/ROC_full_width.png')
plt.close()
...
plt.plot(fpr, tpr, '.-', label='224X224')
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
#plt.xlim(0, 0.001)
plt.xlim(0, 0.01)
...
plt.legend()
#plt.show()
plt.savefig(args.input+'/ROC_zoom_width.png')

...
weaver \
    ...
    --data-val "${DATADIR}/val_file_40.parquet" \
    --data-test "${DATADIR}/val_file_40.parquet" \
    ...
    --num-workers 0 --fetch-step 0.01 --in-memory \
    --batch-size 512 --samples-per-epoch $((2400 * 512)) --samples-per-epoch-val $((800 * 512)) --num-epochs 2 --gpus 0 \
